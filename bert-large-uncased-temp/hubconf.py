...
def config(*args, **kwargs):
    r"""
                ...
                config = torch.hub.load('huggingface/transformers', 'config', 'bert-large-uncased')  # Download configuration from huggingface.co and cache.
                ...
                config = torch.hub.load('huggingface/transformers', 'config', 'bert-large-uncased', output_attentions=True, foo=False)
                assert config.output_attentions == True
                config, unused_kwargs = torch.hub.load('huggingface/transformers', 'config', 'bert-large-uncased', output_attentions=True, foo=False, return_unused_kwargs=True)
                assert config.output_attentions == True
...
def tokenizer(*args, **kwargs):
    r"""
        ...
        tokenizer = torch.hub.load('huggingface/transformers', 'tokenizer', 'bert-large-uncased')    # Download vocabulary from huggingface.co and cache.
...
def model(*args, **kwargs):
    r"""
            ...
            model = torch.hub.load('huggingface/transformers', 'model', 'bert-large-uncased')    # Download model and configuration from huggingface.co and cache.
            ...
            model = torch.hub.load('huggingface/transformers', 'model', 'bert-large-uncased', output_attentions=True)  # Update configuration during loading
...
def modelForMaskedLM(*args, **kwargs):
    r"""
            ...
            model = torch.hub.load('huggingface/transformers', 'modelForMaskedLM', 'bert-large-uncased')    # Download model and configuration from huggingface.co and cache.
            ...
            model = torch.hub.load('huggingface/transformers', 'modelForMaskedLM', 'bert-large-uncased', output_attentions=True)  # Update configuration during loading
            assert model.config.output_attentions == True
            # Loading from a TF checkpoint file instead of a PyTorch model (slower)
            config = AutoConfig.from_pretrained('./tf_model/bert_tf_model_config.json')
...
def modelForSequenceClassification(*args, **kwargs):
    r"""
            ...
            model = torch.hub.load('huggingface/transformers', 'modelForSequenceClassification', 'bert-large-uncased')    # Download model and configuration from huggingface.co and cache.
            ...
            model = torch.hub.load('huggingface/transformers', 'modelForSequenceClassification', 'bert-large-uncased', output_attentions=True)  # Update configuration during loading
            assert model.config.output_attentions == True
            # Loading from a TF checkpoint file instead of a PyTorch model (slower)
            config = AutoConfig.from_pretrained('./tf_model/bert_tf_model_config.json')
...
def modelForQuestionAnswering(*args, **kwargs):
    r"""
        ...
        model = torch.hub.load('huggingface/transformers', 'modelForQuestionAnswering', 'bert-large-uncased')    # Download model and configuration from huggingface.co and cache.
        ...
        model = torch.hub.load('huggingface/transformers', 'modelForQuestionAnswering', 'bert-large-uncased', output_attentions=True)  # Update configuration during loading
        assert model.config.output_attentions == True
        # Loading from a TF checkpoint file instead of a PyTorch model (slower)
        config = AutoConfig.from_pretrained('./tf_model/bert_tf_model_config.json')
