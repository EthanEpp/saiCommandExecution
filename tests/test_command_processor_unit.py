...
#         {"command": "Set the temperature to 20 degrees", "requires_extraction": True}
#     ]
#     mock_embedder = Mock()
...
#     processor.entity_extractor.extract_entities.return_value = ["20 degrees"]
#     processor.clause_extractor.extract_clauses.return_value = ["Set temperature"]

#     input_command = "Set the temperature to 20 degrees"
#     expected_command = "Set the temperature to 20 degrees"
#     result = processor.find_closest_command(input_command)
#     assert result[0] == expected_command
#     assert result[1] == ["20 degrees"]
#     assert result[2] == ["Set temperature"]
