    ...
    def commands(self, command_list: list) -> None:
        ...
        for _ in command_list:
            try:
                ...
                elif command_output_intent == "adjust_volume":
...
# ?
                ...
                elif command_output_intent == "log_in":
                    # print("Command: Logging in")
                    dbusMethods.login()

                elif command_output_intent == "log_out":
                    # print("Command: Log me out")
                    # NEW_TEXT += "Logged you out. "
                    dbusMethods.logout()

                elif command_output_intent == "show_schedule":
                    # print("Command: show schedule")
                    # NEW_TEXT += "Displayed the schedule. "
                    dbusMethods.scheduleCommand("MWL_schedule")
...
# make one
                ...
                elif command_output_intent == "start_zoom_call":
...
# todo make one thing
                ...
                elif command_output_intent == "enlarge_window":
                ...
                elif command_output_intent == "minimize_window":
...
#todo
                ...
                elif command_output_intent == "set_timer":
...
#?
                ...
                elif command_output_intent == "stop_timer":
                ...
                elif command_output_intent == "clear_timer":
...
# timer_reset vs timer_restart
                elif command_output_intent == "timer_reset":
